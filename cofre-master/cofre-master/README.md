...
1. Clone o repositório:
   ```bash
   git clone https://github.com/anderson-uchoa/cofre.git
   cd cofre
   ```
...
1. Abra uma [issue](https://github.com/anderson-uchoa/cofre/issues) no repositório para relatar problemas ou sugerir melhorias.
